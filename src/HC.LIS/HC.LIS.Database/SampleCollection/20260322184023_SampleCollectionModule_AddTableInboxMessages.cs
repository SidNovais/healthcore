...
[Migration(20260322184023)]
public class SampleCollectionModuleAddTableInboxMessages : Migration
{
    public override void Up()
    {
        Create.Table("InboxMessages").InSchema("sample_collection")
    ...
    {
        Delete.Table("InboxMessages").InSchema("sample_collection");
    }
}
