...
internal class GetCollectionRequestByPatientIdQueryHandler(
    ISqlConnectionFactory sqlConnectionFactory
) : IQueryHandler<GetCollectionRequestByPatientIdQuery, CollectionRequestDetailsDto?>
{
    private readonly ISqlConnectionFactory _sqlConnectionFactory = sqlConnectionFactory;

    public async Task<CollectionRequestDetailsDto?> Handle(
        GetCollectionRequestByPatientIdQuery query,
        CancellationToken cancellationToken)
    {
        string sql = @$"SELECT
            ...
            WHERE ""CollectionRequestDetails"".""PatientId"" = @PatientId
            LIMIT 1";
        ...
        return await connection
            .QueryFirstOrDefaultAsync<CollectionRequestDetailsDto>(sql, new { query.PatientId })
