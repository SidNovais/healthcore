...
using HC.LIS.Modules.SampleCollection.Domain;

namespace HC.LIS.Modules.SampleCollection.ArchTests;

public abstract class TestBase
{
    protected static Assembly InfrastructureAssembly => typeof(SampleCollectionModule).Assembly;
