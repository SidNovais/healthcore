...
namespace HC.LIS.Modules.SampleCollection.Infrastructure.Configurations.Processing.Inbox;
...
) : ICommandHandler<ProcessInboxCommand>
{
    ...
    public async Task Handle(ProcessInboxCommand command, CancellationToken cancellationToken)
    {
        ...
        string sql = @$"SELECT
                   ...
                   FROM ""sample_collection"".""InboxMessages"" AS ""InboxMessage""
        ...
        const string sqlUpdateProcessedDate = @$"UPDATE ""sample_collection"".""InboxMessages""
