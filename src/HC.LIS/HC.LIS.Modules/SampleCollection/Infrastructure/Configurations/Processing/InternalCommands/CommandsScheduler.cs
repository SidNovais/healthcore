...
namespace HC.LIS.Modules.SampleCollection.Infrastructure.Configurations.Processing.InternalCommands;
...
) : ICommandsScheduler
{
    ...
    public async Task EnqueueAsync(ICommand command)
    {
        ...
        const string sqlInsert = @$"INSERT INTO ""sample_collection"".""InternalCommands"" (""Id"", ""EnqueueDate"", ""Type"", ""Data"", ""TraceContext"") VALUES " +
