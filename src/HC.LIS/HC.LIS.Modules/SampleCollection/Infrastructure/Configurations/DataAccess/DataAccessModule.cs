...
using HC.LIS.Modules.SampleCollection.Infrastructure.Configurations.AggregateStore;
using Marten;
...
) : Autofac.Module
{
    ...
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder
          .Register(c =>
          {
              var dbContextOptionsBuilder = new DbContextOptionsBuilder<SampleCollectionContext>();
              dbContextOptionsBuilder.UseNpgsql(_databaseConnectionString);
              dbContextOptionsBuilder
              .ReplaceService<IValueConverterSelector, StronglyTypedIdValueConverterSelector>();
              return new SampleCollectionContext(dbContextOptionsBuilder.Options);
          })
          .AsSelf()
          .As<DbContext>()
          .InstancePerLifetimeScope()
