...
using HC.LIS.Modules.UserAccess.Infrastructure.Configurations.Processing.Inbox;
...
namespace HC.LIS.Modules.UserAccess.Infrastructure.Configurations.Quartz;
