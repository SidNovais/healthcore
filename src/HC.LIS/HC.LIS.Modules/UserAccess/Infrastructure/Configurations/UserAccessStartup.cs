...
using HC.LIS.Modules.UserAccess.Infrastructure.Configurations.Authentication;
using HC.LIS.Modules.UserAccess.Infrastructure.Configurations.DataAccess;
using HC.LIS.Modules.UserAccess.Infrastructure.Configurations.EventBus;
using HC.LIS.Modules.UserAccess.Infrastructure.Configurations.Logging;
using HC.LIS.Modules.UserAccess.Infrastructure.Configurations.Mediation;
using HC.LIS.Modules.UserAccess.Infrastructure.Configurations.Observability;
...
using HC.LIS.Modules.UserAccess.Infrastructure.Configurations.Quartz;
using Serilog;
...
public class UserAccessStartup
{
    ...
    {
        ILogger moduleLogger = logger.ForContext("Module", "UserAccess");
        ConfigureContainer(
    ...
    )
    {
        ...
        domainNotificationsMap.Add("UserCreatedNotification",     typeof(UserCreatedNotification));
        domainNotificationsMap.Add("UserActivatedNotification",   typeof(UserActivatedNotification));
        domainNotificationsMap.Add("UserRoleChangedNotification", typeof(UserRoleChangedNotification));
