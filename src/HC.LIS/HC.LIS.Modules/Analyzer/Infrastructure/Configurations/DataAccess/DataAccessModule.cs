...
using HC.LIS.Modules.Analyzer.Infrastructure.Configurations.AggregateStore;
using Marten;
...
) : Autofac.Module
{
    ...
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder
          .Register(c =>
          {
              var dbContextOptionsBuilder = new DbContextOptionsBuilder<AnalyzerContext>();
              dbContextOptionsBuilder.UseNpgsql(_databaseConnectionString);
              dbContextOptionsBuilder
              .ReplaceService<IValueConverterSelector, StronglyTypedIdValueConverterSelector>();
              return new AnalyzerContext(dbContextOptionsBuilder.Options);
          })
          .AsSelf()
          .As<DbContext>()
          .InstancePerLifetimeScope()
