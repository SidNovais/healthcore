...
using HC.LIS.Modules.Analyzer.Infrastructure.Configurations.Processing.Inbox;
...
namespace HC.LIS.Modules.Analyzer.Infrastructure.Configurations.Quartz;
...
internal static class QuartzStartup
{
    ...
    internal static void Initialize(ILogger logger, long? internalProcessingPoolingInterval)
    {
      ...
      {
          { "quartz.scheduler.instanceName", "Analyzer" }
      };
