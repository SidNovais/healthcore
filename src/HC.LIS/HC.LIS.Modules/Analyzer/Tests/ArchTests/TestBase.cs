...
using HC.LIS.Modules.Analyzer.Domain;

namespace HC.LIS.Modules.Analyzer.ArchTests;

public abstract class TestBase
{
    protected static Assembly InfrastructureAssembly => typeof(AnalyzerModule).Assembly;
