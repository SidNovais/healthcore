...
using HC.LIS.Modules.LabAnalysis.Infrastructure.Configurations.Processing.Inbox;
...
namespace HC.LIS.Modules.LabAnalysis.Infrastructure.Configurations.Quartz;
...
internal static class QuartzStartup
{
    ...
    internal static void Initialize(ILogger logger, long? internalProcessingPoolingInterval)
    {
      ...
      {
          { "quartz.scheduler.instanceName", "LabAnalysis" }
      };
