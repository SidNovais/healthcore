...
namespace HC.LIS.Modules.LabAnalysis.Infrastructure.Configurations.Processing.Inbox;
...
) : ICommandHandler<ProcessInboxCommand>
{
    ...
    public async Task Handle(ProcessInboxCommand command, CancellationToken cancellationToken)
    {
        ...
        string sql = @$"SELECT
                   ...
                   FROM ""lab_analysis"".""InboxMessages"" AS ""InboxMessage""
        ...
        const string sqlUpdateProcessedDate = @$"UPDATE ""lab_analysis"".""InboxMessages""
