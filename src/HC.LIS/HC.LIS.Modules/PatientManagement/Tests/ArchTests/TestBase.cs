...
using HC.LIS.Modules.PatientManagement.Domain;

namespace HC.LIS.Modules.PatientManagement.ArchTests;

public abstract class TestBase
{
    protected static Assembly InfrastructureAssembly => typeof(PatientManagementModule).Assembly;
