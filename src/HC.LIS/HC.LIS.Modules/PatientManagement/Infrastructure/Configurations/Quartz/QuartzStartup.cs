...
using HC.LIS.Modules.PatientManagement.Infrastructure.Configurations.Processing.Inbox;
...
namespace HC.LIS.Modules.PatientManagement.Infrastructure.Configurations.Quartz;
...
internal static class QuartzStartup
{
    ...
    internal static void Initialize(ILogger logger, long? internalProcessingPoolingInterval)
    {
      ...
      {
          { "quartz.scheduler.instanceName", "PatientManagement" }
      };
