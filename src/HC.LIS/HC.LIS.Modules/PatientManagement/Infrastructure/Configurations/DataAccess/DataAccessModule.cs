...
using HC.LIS.Modules.PatientManagement.Infrastructure.Configurations.AggregateStore;
using Marten;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Storage.ValueConversion;
using Microsoft.Extensions.Logging;

namespace HC.LIS.Modules.PatientManagement.Infrastructure.Configurations.DataAccess;
...
) : Autofac.Module
{
    ...
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder
          .Register(c =>
          {
              var dbContextOptionsBuilder = new DbContextOptionsBuilder<PatientManagementContext>();
              dbContextOptionsBuilder.UseNpgsql(_databaseConnectionString);
              dbContextOptionsBuilder
              .ReplaceService<IValueConverterSelector, StronglyTypedIdValueConverterSelector>();
              return new PatientManagementContext(dbContextOptionsBuilder.Options);
          })
          .AsSelf()
          .As<DbContext>()
          .InstancePerLifetimeScope()
