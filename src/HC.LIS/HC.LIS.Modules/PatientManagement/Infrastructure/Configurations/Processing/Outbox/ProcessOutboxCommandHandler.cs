...
namespace HC.LIS.Modules.PatientManagement.Infrastructure.Configurations.Processing.Outbox;
...
) : ICommandHandler<ProcessOutboxCommand>
{
    ...
    )
    {
        ...
        string sql = @$"SELECT
                    ...
                    FROM ""patient_management"".""OutboxMessages"" AS ""OutboxMessage""
        ...
        const string sqlUpdateProcessedDate = @$"UPDATE ""patient_management"".""OutboxMessages""
