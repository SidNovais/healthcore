...
namespace HC.LIS.Modules.PatientManagement.Infrastructure.Configurations.EventBus;
    ...
    where T : IntegrationEvent
{
    public async Task Handle(T integrationEvent)
    {
        ...
        string sql = @$"INSERT INTO ""patient_management"".""InboxMessages"" (""Id"", ""OccurredAt"", ""Type"", ""Data"", ""TraceContext"") " +
