...
internal static class HcLisEventRegistry
{
    internal static EventRegistry Build() =>
        new EventRegistry.RegistryBuilder()
            ...
            .Register<PhysicianRegisteredIntegrationEvent>("orders.events", "physician.registered")
            .Register<PhysicianUpdatedIntegrationEvent>("orders.events", "physician.updated")
            .Register<PhysicianDeactivatedIntegrationEvent>("orders.events", "physician.deactivated")
            .Register<PhysicianReactivatedIntegrationEvent>("orders.events", "physician.reactivated")
