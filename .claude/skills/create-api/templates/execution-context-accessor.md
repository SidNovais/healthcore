# Template: ExecutionContextAccessor.cs

**Output path:** `src/HC.LIS/HC.LIS.API/Configuration/ExecutionContext/ExecutionContextAccessor.cs`

Implements `HC.Core.Application.IExecutionContextAccessor`.
Reads identity from JWT claims in `HttpContext.User`.
